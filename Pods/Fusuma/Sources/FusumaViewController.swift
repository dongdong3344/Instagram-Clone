...
@objc public class FusumaViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        let checkImage = fusumaCheckImage != nil ? fusumaCheckImage : UIImage(named: "", in: bundle, compatibleWith: nil)
        let closeImage = fusumaCloseImage != nil ? fusumaCloseImage : UIImage(named: "", in: bundle, compatibleWith: nil)
        ...
        titleLabel.textColor = fusumaTintColor  // 黑色
        titleLabel.font      = fusumaTitleFont  // 18号字
...
private extension FusumaViewController {
    ...
    func changeMode(_ mode: FusumaMode) {
        ...
        case .library:
            ...
            titleLabel.text = NSLocalizedString(fusumaTitle, comment: fusumaTitle)
